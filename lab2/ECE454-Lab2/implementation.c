...
void implementation_driver(struct kv *sensor_values, int sensor_values_count, unsigned char *frame_buffer,
    ...
    struct Pixel * coloredPixels = malloc(width * height * sizeof (struct Pixel));
    ...
    for (int row = 0; row < height; row++){
        ...
        for (int col = 0; col < width - 4; col += 4){
            ...
            index = rowIndex + col * 3 + 3;
            red = frame_buffer[index];
            green = frame_buffer[index + 1];
            blue = frame_buffer[index + 2]; 
            ...
            if (color != 0xffffff){
                ...
                coloredPixels[colorCounter].blue = blue;
                coloredPixels[colorCounter].row = row;
                coloredPixels[colorCounter].col = col + 1;
            ...
            if (color != 0xffffff){
                ...
                coloredPixels[colorCounter].blue = blue;
                coloredPixels[colorCounter].row = row;
                coloredPixels[colorCounter].col = col + 2;
            ...
            if (color != 0xffffff){
                ...
                coloredPixels[colorCounter].blue = blue;
                coloredPixels[colorCounter].row = row;
                coloredPixels[colorCounter].col = col + 3;
        ...
        for (; unrollLeft < width; unrollLeft++){
            int index = rowIndex + unrollLeft * 3;
            int red = frame_buffer[index];
            int green = frame_buffer[index + 1];
            int blue = frame_buffer[index + 2]; 
            ...
            if (color != 0xffffff){
                ...
                coloredPixels[colorCounter].blue = blue;
                coloredPixels[colorCounter].row = row;
                coloredPixels[colorCounter].col = unrollLeft;
    ...
    for (int sensorValueIdx = 0; sensorValueIdx < sensor_values_count; sensorValueIdx++) {
        ...
        if (processed_frames % 25 == 0) {
            ...
            for (int pixelIndex = 0; pixelIndex < colorCounter; pixelIndex ++) {
                int row = coloredPixels[pixelIndex].row;
                int col = coloredPixels[pixelIndex].col;
                ...
                coloredPixels[pixelIndex].row = row;
                coloredPixels[pixelIndex].col = col;
                
            }
 
            verifyFrame(frame_buffer, width, height, grading_mode);

             if (sensor_values_count - processed_frames < 25) {
                free(coloredPixels);
                return;
            }
            // //erase frame
            ...
            int pixelIndex = 0;
            //erase w/ unroll
            for (; pixelIndex < colorCounter - 4; pixelIndex += 4){
                int index = coloredPixels[pixelIndex].row * width * 3 + coloredPixels[pixelIndex].col * 3;
                frame_buffer[index] = 255;
                frame_buffer[index + 1] = 255;
                frame_buffer[index + 2] = 255;

                index = coloredPixels[pixelIndex + 1].row * width * 3 + coloredPixels[pixelIndex + 1].col * 3;
                frame_buffer[index] = 255;
                frame_buffer[index + 1] = 255;
                frame_buffer[index + 2] = 255;

                index = coloredPixels[pixelIndex + 2].row * width * 3 + coloredPixels[pixelIndex + 2].col * 3;
                frame_buffer[index] = 255;
                frame_buffer[index + 1] = 255;
                frame_buffer[index + 2] = 255;

                index = coloredPixels[pixelIndex + 3].row * width * 3 + coloredPixels[pixelIndex + 3].col * 3;
                frame_buffer[index] = 255;
                frame_buffer[index + 1] = 255;
                frame_buffer[index + 2] = 255;
            ...
            for(; pixelIndex < colorCounter; pixelIndex++){
                int index = coloredPixels[pixelIndex].row * width * 3 + coloredPixels[pixelIndex].col * 3;
                frame_buffer[index] = 255;
                frame_buffer[index + 1] = 255;
                frame_buffer[index + 2] = 255;
